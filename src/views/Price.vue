<template>
  <div id="webcrumbs">
    <div class="w-[1200px] bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl shadow-lg"> 
        <main class="flex flex-col items-center justify-center py-32 px-8"> 
            <h1 class="text-6xl font-bold text-center mb-8 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent animate-pulse"> Бесплатно</h1> 
            <p class="text-xl text-gray-600 text-center mb-12 max-w-2xl"> На данный момент мы находимся на этапе разработки, поэтому будем очень рады, если вы просто будете нами пользоваться! </p> 
            <button class="bg-gradient-to-r from-blue-600 to-purple-600 text-white text-xl px-12 py-4 rounded-full hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-300 shadow-lg" @click="goBack"> Назад </button> 
        </main>
    </div>
  </div>
</template>
...
<style scoped>
  ...
  *,
  ...
  #webcrumbs .text-6xl {
    font-size: 97.5px;
    line-height: 107.25000000000001px;
  }
  #webcrumbs .text-sm {
    font-size: 22.75px;
  ...
  #webcrumbs .hover\:from-blue-700:hover {
    --tw-gradient-from: #1d4ed8 var(--tw-gradient-from-position);
    --tw-gradient-to: rgba(29, 78, 216, 0) var(--tw-gradient-to-position);
    --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
  }
  #webcrumbs .hover\:to-purple-700:hover {
    --tw-gradient-to: #7e22ce var(--tw-gradient-to-position);
  }
  #webcrumbs .hover\:text-blue-400:hover {
    --tw-text-opacity: 1;
  ...
  #webcrumbs .hover\:text-purple-600:hover {
    --tw-text-opacity: 1;
